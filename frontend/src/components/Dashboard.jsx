      ...
      <nav className="top-navbar">
        <div className="navbar-container">
          ...
          <div className="navbar-actions">
            ...
            <button className="navbar-btn-orange">Get Started</button>
          </div>
        </div>
      </nav>
      ...
      <div className="content-container">
        ...
        <section className="hero-section-centered">
          <div className="hero-left">
            <div className="status-pill-orange">
              <span className="status-dot-orange"></span> NEXT-GEN FLEET MNGT
            </div>
            
            <h1 className="hero-title-main">
              Plan Smarter.<br />
              Drive Further.<br />
              <span className="orange-highlight">Stay Compliant.</span>
            </h1>
            
            <p className="hero-description-main">
              Precision logistics powered by AI. Optimize every mile with real-time route adjustments, automated ELD logging, and total FMCSA compliance—all in one high-fidelity interface.
            </p>

            <div className="hero-buttons-main">
              <button className="btn-plan-trip">
                <FiMap className="btn-icon-left" /> Plan a Trip
              </button>
              <button className="btn-watch-demo">
                <FiPlay className="btn-icon-left" /> Watch Demo
              </button>
            </div>
          </div>
          ...
          <div className="hero-right-media">
            <div className="video-card-wrapper">
              <video 
                src="/The_truck_is_not_shown_fully_m.mp4" 
                autoPlay 
                loop 
                muted 
                playsInline 
                className="hero-video-player-centered"
              />
              
              <div className="video-overlay-info">
                <div className="overlay-left">
                  <span className="overlay-lbl">Live Dispatch</span>
                  <span className="overlay-val">ROUTE RM-21-9 ACTIVE</span>
                </div>
                <div className="overlay-right">
                  <span className="overlay-lbl">ETA</span>
                  <span className="overlay-val">11:45 PM</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="cta-modern-section">
          ...
          <div className="cta-modern-buttons">
            <button className="btn-modern-orange">Start Free Trial</button>
